...
float uint32_to_float(const uint8_t *byteArray) {
  ...
  uint32_t uintValue = (static_cast<uint32_t>(byteArray[0]) << 0) | (static_cast<uint32_t>(byteArray[1]) << 8) |
                       (static_cast<uint32_t>(byteArray[2]) << 16) | (static_cast<uint32_t>(byteArray[3]) << 24);
...
float int32_to_float(const uint8_t *byteArray) {
  ...
  int32_t intValue = (static_cast<int32_t>(byteArray[0]) << 0) | (static_cast<int32_t>(byteArray[1]) << 8) |
                     (static_cast<int32_t>(byteArray[2]) << 16) | (static_cast<int32_t>(byteArray[3]) << 24);
...
void JkRS485Bms::set_precharging_switch(JkRS485BmsSwitch *precharging_switch) {
  this->precharging_switch_ = precharging_switch;
}
void JkRS485Bms::set_charging_switch(JkRS485BmsSwitch *charging_switch) { this->charging_switch_ = charging_switch; }
void JkRS485Bms::set_discharging_switch(JkRS485BmsSwitch *discharging_switch) {
  this->discharging_switch_ = discharging_switch;
}
void JkRS485Bms::set_balancing_switch(JkRS485BmsSwitch *balancer_switch) { this->balancer_switch_ = balancer_switch; }
void JkRS485Bms::set_emergency_switch(JkRS485BmsSwitch *emergency_switch) {
  this->emergency_switch_ = emergency_switch;
}
void JkRS485Bms::set_heating_switch(JkRS485BmsSwitch *heating_switch) { this->heating_switch_ = heating_switch; }
void JkRS485Bms::set_display_always_on_switch(JkRS485BmsSwitch *display_always_on_switch) {
  this->display_always_on_switch_ = display_always_on_switch;
}
void JkRS485Bms::set_charging_float_mode_switch(JkRS485BmsSwitch *charging_float_mode_switch) {
  this->charging_float_mode_switch_ = charging_float_mode_switch;
}
void JkRS485Bms::set_disable_temperature_sensors_switch(JkRS485BmsSwitch *disable_temperature_sensors_switch) {
  this->disable_temperature_sensors_switch_ = disable_temperature_sensors_switch;
}
void JkRS485Bms::set_timed_stored_data_switch(JkRS485BmsSwitch *timed_stored_data_switch) {
  this->timed_stored_data_switch_ = timed_stored_data_switch;
}
void JkRS485Bms::set_gps_heartbeat_switch(JkRS485BmsSwitch *gps_heartbeat_switch) {
  this->gps_heartbeat_switch_ = gps_heartbeat_switch;
}
void JkRS485Bms::set_port_selection_switch(JkRS485BmsSwitch *port_selection_switch) {
  this->port_selection_switch_ = port_selection_switch;
}
void JkRS485Bms::set_special_charger_switch(JkRS485BmsSwitch *special_charger_switch) {
  this->special_charger_switch_ = special_charger_switch;
}
void JkRS485Bms::set_smart_sleep_on_switch(JkRS485BmsSwitch *smart_sleep_on_switch) {
  this->smart_sleep_on_switch_ = smart_sleep_on_switch;
}

void JkRS485Bms::set_cell_smart_sleep_voltage_number(JkRS485BmsNumber *cell_smart_sleep_voltage_number) {
  this->cell_smart_sleep_voltage_number_ = cell_smart_sleep_voltage_number;
}
void JkRS485Bms::set_cell_undervoltage_protection_number(JkRS485BmsNumber *cell_undervoltage_protection_number) {
  this->cell_undervoltage_protection_number_ = cell_undervoltage_protection_number;
}
void JkRS485Bms::set_cell_undervoltage_protection_recovery_number(
    JkRS485BmsNumber *cell_undervoltage_protection_recovery_number) {
  this->cell_undervoltage_protection_recovery_number_ = cell_undervoltage_protection_recovery_number;
}
void JkRS485Bms::set_cell_overvoltage_protection_number(JkRS485BmsNumber *cell_overvoltage_protection_number) {
  this->cell_overvoltage_protection_number_ = cell_overvoltage_protection_number;
}
void JkRS485Bms::set_cell_overvoltage_protection_recovery_number(
    JkRS485BmsNumber *cell_overvoltage_protection_recovery_number) {
  this->cell_overvoltage_protection_recovery_number_ = cell_overvoltage_protection_recovery_number;
}
void JkRS485Bms::set_cell_balancing_trigger_voltage_number(JkRS485BmsNumber *cell_balancing_trigger_voltage_number) {
  this->cell_balancing_trigger_voltage_number_ = cell_balancing_trigger_voltage_number;
}
void JkRS485Bms::set_cell_soc100_voltage_number(JkRS485BmsNumber *cell_soc100_voltage_number) {
  this->cell_soc100_voltage_number_ = cell_soc100_voltage_number;
}
void JkRS485Bms::set_cell_soc0_voltage_number(JkRS485BmsNumber *cell_soc0_voltage_number) {
  this->cell_soc0_voltage_number_ = cell_soc0_voltage_number;
}
void JkRS485Bms::set_cell_request_charge_voltage_number(JkRS485BmsNumber *cell_request_charge_voltage_number) {
  this->cell_request_charge_voltage_number_ = cell_request_charge_voltage_number;
}
void JkRS485Bms::set_cell_request_float_voltage_number(JkRS485BmsNumber *cell_request_float_voltage_number) {
  this->cell_request_float_voltage_number_ = cell_request_float_voltage_number;
}
void JkRS485Bms::set_cell_power_off_voltage_number(JkRS485BmsNumber *cell_power_off_voltage_number) {
  this->cell_power_off_voltage_number_ = cell_power_off_voltage_number;
}
void JkRS485Bms::set_cell_balancing_starting_voltage_number(JkRS485BmsNumber *cell_balancing_starting_voltage_number) {
  this->cell_balancing_starting_voltage_number_ = cell_balancing_starting_voltage_number;
}
void JkRS485Bms::set_max_charging_current_number(JkRS485BmsNumber *max_charging_current_number) {
  this->max_charging_current_number_ = max_charging_current_number;
}
void JkRS485Bms::set_charging_overcurrent_protection_delay_number(
    JkRS485BmsNumber *charging_overcurrent_protection_delay_number) {
  this->charging_overcurrent_protection_delay_number_ = charging_overcurrent_protection_delay_number;
}
void JkRS485Bms::set_charging_overcurrent_protection_recovery_delay_number(
    JkRS485BmsNumber *charging_overcurrent_protection_recovery_delay_number) {
  this->charging_overcurrent_protection_recovery_delay_number_ = charging_overcurrent_protection_recovery_delay_number;
}
void JkRS485Bms::set_max_discharging_current_number(JkRS485BmsNumber *max_discharging_current_number) {
  this->max_discharging_current_number_ = max_discharging_current_number;
}
void JkRS485Bms::set_discharging_overcurrent_protection_delay_number(
    JkRS485BmsNumber *discharging_overcurrent_protection_delay_number) {
  this->discharging_overcurrent_protection_delay_number_ = discharging_overcurrent_protection_delay_number;
}
void JkRS485Bms::set_discharging_overcurrent_protection_recovery_delay_number(
    JkRS485BmsNumber *discharging_overcurrent_protection_recovery_delay_number) {
  this->discharging_overcurrent_protection_recovery_delay_number_ =
      discharging_overcurrent_protection_recovery_delay_number;
}
void JkRS485Bms::set_short_circuit_protection_delay_number(JkRS485BmsNumber *short_circuit_protection_delay_number) {
  this->short_circuit_protection_delay_number_ = short_circuit_protection_delay_number;
}
void JkRS485Bms::set_short_circuit_protection_recovery_delay_number(
    JkRS485BmsNumber *short_circuit_protection_recovery_delay_number) {
  this->short_circuit_protection_recovery_delay_number_ = short_circuit_protection_recovery_delay_number;
}
void JkRS485Bms::set_max_balancing_current_number(JkRS485BmsNumber *max_balancing_current_number) {
  this->max_balancing_current_number_ = max_balancing_current_number;
}

void JkRS485Bms::set_charging_overtemperature_protection_number(
    JkRS485BmsNumber *charging_overtemperature_protection_number) {
  this->charging_overtemperature_protection_number_ = charging_overtemperature_protection_number;
}
void JkRS485Bms::set_charging_overtemperature_protection_recovery_number(
    JkRS485BmsNumber *charging_overtemperature_protection_recovery_number) {
  this->charging_overtemperature_protection_recovery_number_ = charging_overtemperature_protection_recovery_number;
}
void JkRS485Bms::set_discharging_overtemperature_protection_number(
    JkRS485BmsNumber *discharging_overtemperature_protection_number) {
  this->discharging_overtemperature_protection_number_ = discharging_overtemperature_protection_number;
}
void JkRS485Bms::set_discharging_overtemperature_protection_recovery_number(
    JkRS485BmsNumber *discharging_overtemperature_protection_recovery_number) {
  this->discharging_overtemperature_protection_recovery_number_ =
      discharging_overtemperature_protection_recovery_number;
}
void JkRS485Bms::set_charging_lowtemperature_protection_number(
    JkRS485BmsNumber *charging_lowtemperature_protection_number) {
  this->charging_lowtemperature_protection_number_ = charging_lowtemperature_protection_number;
}
void JkRS485Bms::set_charging_lowtemperature_protection_recovery_number(
    JkRS485BmsNumber *charging_lowtemperature_protection_recovery_number) {
  this->charging_lowtemperature_protection_recovery_number_ = charging_lowtemperature_protection_recovery_number;
}
void JkRS485Bms::set_mos_overtemperature_protection_number(JkRS485BmsNumber *mos_overtemperature_protection_number) {
  this->mos_overtemperature_protection_number_ = mos_overtemperature_protection_number;
}
void JkRS485Bms::set_mos_overtemperature_protection_recovery_number(
    JkRS485BmsNumber *mos_overtemperature_protection_recovery_number) {
  this->mos_overtemperature_protection_recovery_number_ = mos_overtemperature_protection_recovery_number;
}

void JkRS485Bms::set_cell_count_settings_number(JkRS485BmsNumber *cell_count_settings_number) {
  this->cell_count_settings_number_ = cell_count_settings_number;
}
void JkRS485Bms::set_battery_capacity_total_settings_number(JkRS485BmsNumber *battery_capacity_total_settings_number) {
  this->battery_capacity_total_settings_number_ = battery_capacity_total_settings_number;
}
void JkRS485Bms::set_precharging_time_from_discharge_number(JkRS485BmsNumber *precharging_time_from_discharge_number) {
  this->precharging_time_from_discharge_number_ = precharging_time_from_discharge_number;
}

void JkRS485Bms::set_cell_request_charge_voltage_time_number(
    JkRS485BmsNumber *cell_request_charge_voltage_time_number) {
  this->cell_request_charge_voltage_time_number_ = cell_request_charge_voltage_time_number;
}
void JkRS485Bms::set_cell_request_float_voltage_time_number(JkRS485BmsNumber *cell_request_float_voltage_time_number) {
  this->cell_request_float_voltage_time_number_ = cell_request_float_voltage_time_number;
}
...
void JkRS485Bms::trigger_bms2sniffer_switch_or_number_uint32_event(std::uint16_t register_address,
  ...
  this->parent_->handle_bms2sniffer_switch_or_number_uint32_event(this->address_, third_element_of_frame,
                                                                  register_address, value);
}

void JkRS485Bms::trigger_bms2sniffer_switch_or_number_int32_event(std::uint16_t register_address,
                                                                  std::uint8_t third_element_of_frame,
                                                                  std::int32_t value) {
  ...
  //    // Log final
  ESP_LOGD(TAG, "BMS address %02X switch_register_address [32bit] %02X", this->address_, register_address);
  this->parent_->handle_bms2sniffer_switch_or_number_int32_event(this->address_, third_element_of_frame,
                                                                 register_address, value);
}
...
void JkRS485Bms::trigger_bms2sniffer_switch16_event(std::uint16_t register_address,
                                                    std::uint8_t third_element_of_frame) {
  ...
  if ((this->heating_switch_->is_ready()) && (this->disable_temperature_sensors_switch_->is_ready()) &&
    ...
    this->parent_->handle_bms2sniffer_switch_or_number_uint16_event(this->address_, third_element_of_frame,
                                                                    register_address, value_to_send);
  } else {
    ESP_LOGD(TAG, "BMS address %02X switch_register_address [16bit] %02X (NOT READY ALL SWITCHES)", this->address_,
             register_address);
  }
}

void JkRS485Bms::trigger_bms2sniffer_number16_event(std::uint16_t register_address,
                                                    std::uint8_t third_element_of_frame) {
...
void JkRS485Bms::on_jk_rs485_sniffer_data(const uint8_t &origin_address, const uint8_t &frame_type,
  ...
  ESP_LOGVV(TAG, "on_jk_rs485_sniffer_data -->");
  ...
  if (origin_address == this->address_) {
    ESP_LOGD(TAG, "This BMS address is: %d  and address received %d ==> WORKING (frame type:%d)", this->address_,
...
void JkRS485Bms::decode_jk02_cell_info_(const std::vector<uint8_t> &data) {
  ...
  // .F4.00.F8.00.AF.03.AB.24.37.0A.14.00.00.00.80.51.01.00.00.00.00.01.00.00.00.00.00.00.00.00.00.FE.FF.7F.DC.2F.01.01.B0.0F.00.00.00.36.00.10.16.20.00.01.05.9A.00
  // (309)
  ...
  for (uint8_t i = 0; i < cells; i++) {
    ...
    cell_resistance =
        uint16_to_float(&data[(i * 2 + 64 + offset)]) * 0.001f;  //(float) jk_get_16bit(i * 2 + 64 + offset) * 0.001f;
  ...
  if (this->arr[1] == 0) {
    ...
    this->publish_state_(this->cell_average_voltage_sensor_,
                         uint16_to_float(&data[58 + offset]) * 0.001f);  // (float) jk_get_16bit(58 + offset) * 0.001f);

    // 60    2   0x00 0x00              cell delta voltage    0.001        V
    this->publish_state_(this->cell_delta_voltage_sensor_,
                         uint16_to_float(&data[60 + offset]) * 0.001f);  // (float) jk_get_16bit(60 + offset) * 0.001f);
    ...
    // 114   4   0x00 0x00 0x00 0x00    Wire resistance warning bitmask (each bit indicates a warning per cell /
    // wire) ESP_LOGD(TAG, "Wire resistance warning bitmask: 0x%02X 0x%02X 0x%02X 0x%02X", data[114 + offset],
    // data[115 + offset],data[116 + offset], data[117 + offset]);

    // 118 [144=118+26]  4   0x03 0xD0 0x00 0x00    Battery voltage       0.001        V
    float battery_voltage =
        uint32_to_float(&data[118 + offset]) * 0.001f;  //(float) jk_get_32bit(118 + offset) * 0.001f;
    ...
    if (frame_version == FRAME_VERSION_JK02_32S) {
      ...
      /*    ESP_LOGI(TAG, "alarm_WireRes_binary_sensor_:                  %d", this->check_bit_of_byte_(data[134],
         0)); ESP_LOGI(TAG, "alarm_MosOTP_binary_sensor_:                   %d", this->check_bit_of_byte_(data[134],
         1)); ESP_LOGI(TAG, "alarm_CellQuantity_binary_sensor_:             %d", this->check_bit_of_byte_(data[134],
         2)); ESP_LOGI(TAG, "alarm_CurSensorErr_binary_sensor_:             %d", this->check_bit_of_byte_(data[134],
         3)); ESP_LOGI(TAG, "alarm_CellOVP_binary_sensor_:                  %d", this->check_bit_of_byte_(data[134],
         4)); ESP_LOGI(TAG, "alarm_BatOVP_binary_sensor_:                   %d", this->check_bit_of_byte_(data[134],
         5)); ESP_LOGI(TAG, "alarm_ChOCP_binary_sensor_:                    %d", this->check_bit_of_byte_(data[134],
         6)); ESP_LOGI(TAG, "alarm_ChSCP_binary_sensor_:                    %d", this->check_bit_of_byte_(data[134],
         7));*/
    }
    ...
    if (frame_version == FRAME_VERSION_JK02_32S) {
      ...
      this->publish_state_(
          this->temperature_powertube_sensor_,
    ...
    if (this->arr[1] == 1) {
      ...
      if (frame_version == FRAME_VERSION_JK02_32S) {
        ...
        this->publish_alarm_state_(this->alarm_dischargeonfailed_binary_sensor_,
                                   this->check_bit_of_byte_(data[136], 4));
        this->publish_alarm_state_(this->alarm_batteryovertemp_binary_sensor_, this->check_bit_of_byte_(data[136], 5));
        this->publish_alarm_state_(this->alarm_temperaturesensoranomaly_binary_sensor_,
                                   this->check_bit_of_byte_(data[136], 6));
      ...
      if (frame_version == FRAME_VERSION_JK02_32S) {
        ...
        // raw_errors_bitmask = (((uint16_t(data[136 + offset]) << 0) | (uint16_t(data[137 + offset]) << 8)) << 16) |
        // raw_errors_bitmask;
        uint32_t raw_errors_bitmask = (uint32_t(data[134 + 3 + offset]) << 24) |
                                      (uint32_t(data[134 + 2 + offset]) << 16) |
                                      (uint32_t(data[134 + 1 + offset]) << 8) | (uint32_t(data[134 + 0 + offset]) << 0);
      ...
      this->publish_state_(this->battery_capacity_total_settings_number_,
                           uint32_to_float(&data[146 + offset]) * 0.001f);

      // 150 [176=150+26]  4   0x00 0x00 0x00 0x00    Cycle_Count          1.0
      this->publish_state_(this->charging_cycles_sensor_,
                           uint32_to_float(&data[150 + offset]));  // (float) jk_get_32bit(150 + offset));

      // 154 [180=154+26]  4   0x3D 0x04 0x00 0x00    Cycle_Capacity       0.001         Ah
      this->publish_state_(
          this->battery_capacity_total_charging_cycle_sensor_,
          uint32_to_float(&data[154 + offset]) * 0.001f);  //  (float) jk_get_32bit(154 + offset) * 0.001f);
      ...
      this->publish_state_(this->battery_total_runtime_sensor_,
                           temp_param_value);  //  (float) jk_get_32bit(162 + offset));
      ...
      // 166  [192=166+26]   1   0x01                   Charging mosfet enabled                      0x00: off, 0x01:
      // on
      ...
      //  167  [193=167+26]  1   0x01                   Discharging mosfet enabled                   0x00: off, 0x01:
      //  on
      ...
      this->publish_state_(this->discharging_overcurrent_protection_release_time_sensor_,
                           uint16_to_float(&data[170 + offset]));  //  (float) jk_get_16bit(170 + offset));
      // 172  [198=172+26] 2                          TimeDcSCPR   Time for Discharge Short Circuit Protection Release
      this->publish_state_(this->discharging_short_circuit_protection_release_time_sensor_,
                           uint16_to_float(&data[172 + offset]));  // (float) jk_get_16bit(172 + offset));
      // 174  [200=174+26] 2                          TimeCOCPR    Time for Charge Overcurrent Protection Release
      this->publish_state_(this->charging_overcurrent_protection_release_time_sensor_,
                           uint16_to_float(&data[174 + offset]));  // (float) jk_get_16bit(174 + offset));
      // 176  [202=176+26] 2                          TimeCSCPR    Time for Charge Short Circuit Protection Release
      this->publish_state_(this->charging_short_circuit_protection_release_time_sensor_,
                           uint16_to_float(&data[176 + offset]));  // (float) jk_get_16bit(176 + offset));
      // 178  [204=178+26] 2                          TimeUVPR     Time for Single Cell Under Voltage Protection
      // Release
      this->publish_state_(this->cell_undervoltage_protection_release_time_sensor_,
                           uint16_to_float(&data[178 + offset]));  //  (float) jk_get_16bit(178 + offset));
      // 180  [206=180+26] 2                          TimeOVPR     Time for Single Cell Over Voltage Protection
      // Release
      this->publish_state_(this->cell_overvoltage_protection_release_time_sensor_,
                           uint16_to_float(&data[180 + offset]));  // (float) jk_get_16bit(180 + offset));
      // .........
      ...
      ESP_LOGV(TAG, " [0x%02X]* emergency_switch_                                is byte %02X address %p",
               this->address_, (temp_param_value > 0), (void *) this->emergency_switch_);
      ...
      // 202 [228=202+26]                          228.Battery Voltage       0.01         V   (repeated. More
      // precision at 118) battery_voltage = (float) jk_get_32bit(202 + offset) * 0.01f; ESP_LOGI(TAG, " BATTERY
      // VOLTAGE 228: %f", battery_voltage);
      ...
      if (frame_version == FRAME_VERSION_JK02_32S) {
        ...
        //    bit6:                                        64
        //    bit7:                                        128
        this->publish_alarm_state_(this->alarm_mostempsensorabsent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 0));
        this->publish_alarm_state_(this->alarm_battempsensor1absent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 1));
        this->publish_alarm_state_(this->alarm_battempsensor2absent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 2));
        this->publish_alarm_state_(this->alarm_battempsensor3absent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 3));
        this->publish_alarm_state_(this->alarm_battempsensor4absent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 4));
        this->publish_alarm_state_(this->alarm_battempsensor5absent_binary_sensor_,
                                   !this->check_bit_of_byte_(data[(182 + offset)], 5));

        // 180 [212=180+32]

        //          206
        // ESP_LOGV(TAG, "  TimeUVPR??:  %f", uint16_to_float(&data[178+offset]));  // ((int16_t) jk_get_16bit(178 +
        // offset))); ESP_LOGV(TAG, "  TimeOVPR??:  %f", uint16_to_float(&data[180+offset]));  // ((int16_t)
        // jk_get_16bit(180 + offset)));
        ...
        // 208 [240] SysRunTicks
        // ESP_LOGV(TAG, "  SysRunTicks:  %f", uint32_to_float(&data[208+offset]));   //(int32_t) jk_get_32bit(208 +
        // offset)));
      }
...
void JkRS485Bms::track_status_online_() {
  if (this->no_response_count_ < MAX_NO_RESPONSE_COUNT) {
    ...
    // ESP_LOGD(TAG, "  ########################################################################################
    // NO RESPONSE [0x%02X] count:%02d ",this->address_,this->no_response_count_);
  } else {
    if (this->no_response_count_ == MAX_NO_RESPONSE_COUNT) {
...
void JkRS485Bms::publish_state_(sensor::Sensor *sensor, float value) {
  ...
  // reinterpret_cast<uintptr_t>(sensor)); sensor->publish_state(value);
...
void JkRS485Bms::publish_state_(JkRS485BmsSwitch *obj, const bool &state) {
  ...
  if (reinterpret_cast<uintptr_t>(obj) > 0x3f000000) {
    ESP_LOGV(TAG, "       ]* Publishing state %d for object with address %p [%f] %s", state, (void *) obj,
             ((float) free_heap / 1024), obj->get_name().c_str());
    obj->publish_state(state);
    ESP_LOGV(TAG, "  --------------------------------------- PUBLISHED     0x%02X publish_state(state) of %s",
             reinterpret_cast<uintptr_t>(obj), obj->get_name().c_str());
  } else {
    ESP_LOGE(TAG, "  NOT PUBLISHED, because object changed its pointer ?? ---------]* 0x%02X",
...
void JkRS485Bms::publish_state_(JkRS485BmsNumber *number, float value) {
  ...
  if (reinterpret_cast<uintptr_t>(number) > 0x3f000000) {
    ...
    ESP_LOGV(TAG, "  --------------------------------------- PUBLISHED     0x%02X publish_state(state) of %s",
             reinterpret_cast<uintptr_t>(number), number->get_name().c_str());
  } else {
    ESP_LOGE(TAG, "  NOT PUBLISHED, because object changed its pointer ?? ---------]* 0x%02X",
             reinterpret_cast<uintptr_t>(number));
  }
}
...
void JkRS485Bms::dump_config() {  // NOLINT(google-readability-function-size,readability-function-size)
  ...
  LOG_SENSOR("", "Powertube temperature protection recovery",
  this->powertube_temperature_protection_recovery_sensor_); LOG_SENSOR("", "Temperature Sensor Temperature
  Protection", this->temperature_sensor_temperature_protection_sensor_); LOG_SENSOR("", "Temperature Sensor
  Temperature Recovery", this->temperature_sensor_temperature_recovery_sensor_); LOG_SENSOR("", "Temperature
  Sensor Temperature Difference Protection", this->temperature_sensor_temperature_difference_protection_sensor_);
  LOG_SENSOR("", "Charging High Temperature Protection", this->charging_high_temperature_protection_sensor_);
  LOG_SENSOR("", "Discharging High Temperature Protection",
  this->discharging_high_temperature_protection_sensor_); LOG_SENSOR("", "Charging Low Temperature Protection",
  this->charging_low_temperature_protection_sensor_); LOG_SENSOR("", "Charging Low Temperature Recovery",
  this->charging_low_temperature_recovery_sensor_); LOG_SENSOR("", "Discharging Low Temperature Protection",
  this->discharging_low_temperature_protection_sensor_); LOG_SENSOR("", "Discharging Low Temperature Recovery",
  this->discharging_low_temperature_recovery_sensor_); LOG_SENSOR("", "Battery capacity total setting",
  this->battery_capacity_total_setting_sensor_); LOG_SENSOR("", "Current Calibration",
  this->current_calibration_sensor_); LOG_SENSOR("", "Device Address", this->device_address_sensor_);
